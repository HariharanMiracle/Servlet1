...
<header>
	...
	<h3><center>Welcome to Warakagoda Tea Factory!!</center></h1>
			...
			<center>
				...
				<br/>
				<a href = "WeeklyReportServelet">Weekly transportation schedule</a>
				<br/>
				<a href = "InventoryNotificationServlet">Inventory level notification</a>
				<br/>
				<a href = "TrackOrderServlet">Track Order and update status</a>
				<br/>
				<a href = "GenerateMonthlyPurchaseReportServlet">Generate Monthly Purchase Report</a>
			</center>
